            ...
            if (munData) {
                ...
                if (currentSubject === 'bel_score') {
                    ...
                    detailsHtml = `
                        ...
                        <p><b>Средно точки БЕЛ:</b> <span style="color:#0F2D4A; font-weight:bold;">${munData.bel_score} т.</span></p>
                    ...
                    detailsHtml = `
                        <h3>общ. ${munNameGeo}</h3>
                        <p><b>Учебна година:</b> ${selectedYear}</p>
                        <p><b>Средно точки Математика:</b> <span style="color:#0F2D4A; font-weight:bold;">${munData.mat_score} т.</span></p>
